  ...
  return (
    <VStack className="self-center w-full md:rounded-lg flex-1 bg-background-0">
      ...
      <VStack className="h-full px-4 pt-8 md:px-5" space="lg">
        ...
        <HStack className="items-center gap-2 mt-2 items-start">
          <Icon as={InfoIcon} className="w-4 h-4 text-info-500 shrink-0" />
          <Text className="text-typography-500 text-sm">
            For the purpose of the demo, any changes made won't be reflected on
            the server in order to maintain the app's sanity.
          </Text>
        </HStack>
